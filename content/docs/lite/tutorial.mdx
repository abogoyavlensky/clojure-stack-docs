...
The default configuration of the server component is provided by the
...
This approach provides immediate feedback to users without page refreshes, creating a smooth, app-like experience while maintaining the simplicity of server-side rendering.

## Delete a Movie

To delete a movie, let's add a query, handler, and route for it. The route will look like this:
...
list pagination, etc. This tutorial provides a solid foundation to build your own application.
