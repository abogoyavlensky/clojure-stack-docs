...
- `:deploy` - Choose between [Kamal](https://kamal-deploy.org/) and no deployment configuration (*Default:* `:kamal`)
    - Available values: `:kamal` or `:none`

<Callout type="info">More info at: [Generate Project - Options](/docs/lite/generate-project#options)</Callout>
