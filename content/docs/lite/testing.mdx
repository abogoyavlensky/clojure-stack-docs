...
For integration tests we start the system using existing fixture:
...
Then in your tests you can have an access the system components via `myproject.test-utils/*test-system*` dynamic variable. It contains the system map with all the components started with the `:test` profile.
