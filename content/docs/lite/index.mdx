...
This template empowers you to get started with Clojure in a simple Server-side Rendering (SSR) setup. In just a few steps, you'll have a fully functional application ready for development and production deployment. The generated project comes with carefully selected defaults that balance simplicity with power, while remaining fully customizable to meet your specific requirements.

## Why Choose Clojure Stack Lite?

- **Developer Experience First**: One command starts your entire development environment with auto-reload for code and styles
- **Production Ready**: Includes CI/CD pipelines, deployment configurations, and performance optimizations out of the box
- **Modern Frontend, Minimal JavaScript**: Leverage HTMX and AlpineJS for interactive UIs without complex JavaScript frameworks
- **Batteries Included**: Database migrations, testing setup, and more
- **Focus on Your Business Logic**: Spend time building features, not configuring infrastructure
